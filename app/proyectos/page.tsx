...
function RepoCard({ repo }: { repo: Repo }) {
  ...
  return (
    ...
    >
      ...
      <h3 className="repo-card__name">{displayName}</h3>
      {repo.description && (
...
export default function ProyectosPage() {
  ...
  useEffect(() => {
    ...
    fetch(
      "https://api.github.com/users/MariaDSalazar/repos?sort=updated&per_page=30",
      {
        ...
        <div className="content-section__inner">
          ...
          <div className="page-hero reveal" data-reveal="">
            ...
            <p className="page-hero__desc">
              Repositorios públicos — desde prototipos IoT hasta herramientas de ciberseguridad.
            </p>
          </div>
          ...
          {status === "error" && (
            <div className="projects-error">
              <svg aria-hidden="true" fill="none" viewBox="0 0 24 24" width="40" height="40">
              ...
              <p>No se pudieron cargar los repositorios. Puede ser un límite temporal de la API de GitHub.</p>
              <a
