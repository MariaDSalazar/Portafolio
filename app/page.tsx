...
const techChips = [
  ...
  { label: "QA & Testing",           icon: "M12 3c2.7 2 5.6 3 8 3v5c0 5-3.4 8.9-8 10-4.6-1.1-8-5-8-10V6c2.4 0 5.3-1 8-3Zm-3 9 2 2 4-4" },
  { label: "Diseño Web",             icon: "M4 8a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2Zm0 3h16" },
  { label: "Administración de Servidores", icon: "M4 7a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2Zm0 8a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2Zm3-7h.01M7 17h.01" },
];
